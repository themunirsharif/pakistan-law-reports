...
// Entries that were mislabeled as judgments but are actually statutes,
// forms, articles, or other non-judgment content - identified by the
// document-type classifier.
export function getNonJudgmentEntries() {
  return indexData.filter((j) => j.content_type && j.content_type !== 'JUDGMENT');
}
